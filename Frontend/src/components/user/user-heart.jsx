    ...
    <div className="user-heart-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <select name="currentSmoker" value={formData.currentSmoker} onChange={handleInputChange} required>
            <option value="">Select</option>
        ...
        <div className="form-group">
          ...
          <input type="number" name="cigsPerDay" value={formData.cigsPerDay} onChange={handleInputChange} required />
        </div>

        <div className="form-group">
          <label htmlFor="BPMeds">On Blood Pressure Medication:</label>
          <select name="BPMeds" value={formData.BPMeds} onChange={handleInputChange} required>
            <option value="">Select</option>
            <option value="1">Yes</option>
            <option value="0">No</option>
          </select>
        ...
        <div className="form-group">
          ...
          <select name="prevalentStroke" value={formData.prevalentStroke} onChange={handleInputChange} required>
            <option value="">Select</option>
            <option value="1">Yes</option>
            <option value="0">No</option>
          </select>
        ...
        <div className="form-group">
          ...
          <select name="prevalentHyp" value={formData.prevalentHyp} onChange={handleInputChange} required>
            <option value="">Select</option>
            <option value="1">Yes</option>
            <option value="0">No</option>
          </select>
        ...
        <div className="form-group">
          ...
          <select name="diabetes" value={formData.diabetes} onChange={handleInputChange} required>
            <option value="">Select</option>
            <option value="1">Yes</option>
            <option value="0">No</option>
          </select>
        ...
        <div className="form-group">
          ...
          <input type="number" name="totChol" value={formData.totChol} onChange={handleInputChange} required />
        </div>

        <div className="form-group">
          <label htmlFor="sysBP">Systolic Blood Pressure (mmHg):</label>
          <input type="number" name="sysBP" value={formData.sysBP} onChange={handleInputChange} required />
        </div>

        <div className="form-group">
          <label htmlFor="diaBP">Diastolic Blood Pressure (mmHg):</label>
          <input type="number" name="diaBP" value={formData.diaBP} onChange={handleInputChange} required />
        </div>

        <div className="form-group">
          <label htmlFor="BMI">BMI:</label>
          <input type="number" name="BMI" value={formData.BMI} onChange={handleInputChange} required step="0.1" />
        </div>

        <div className="form-group">
          <label htmlFor="heartRate">Heart Rate (bpm):</label>
          <input type="number" name="heartRate" value={formData.heartRate} onChange={handleInputChange} required />
        </div>
